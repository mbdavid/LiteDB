...
public class QueryIgnoreExpressionPropertiesBenchmark : BenchmarkBase
{
    ...
    public void GlobalSetup()
    {
        ...
        _fileMetaCollection.Insert(
            FileMetaGenerator<FileMetaBase>.GenerateList(DatasetSize)); // executed once per each N value
    ...
    public void GlobalIndexSetup()
    {
        ...
        _fileMetaExclusionCollection.Insert(
            FileMetaGenerator<FileMetaWithExclusion>.GenerateList(DatasetSize)); // executed once per each N value
