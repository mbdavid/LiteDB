...
SET @int      = SELECT COUNT($) FROM col_datatype WHERE is_int = true;
SET @long     = SELECT COUNT($) FROM col_datatype WHERE is_long = true;
SET @date     = SELECT COUNT($) FROM col_datatype WHERE is_date = true;
SET @guid     = SELECT COUNT($) FROM col_datatype WHERE is_guid = true;
SET @objectid = SELECT COUNT($) FROM col_datatype WHERE is_objectid = true;
