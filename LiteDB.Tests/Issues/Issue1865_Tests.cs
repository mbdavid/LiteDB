...
public class Issue1865_Tests
{
    ...
    public void Incluced_document_types_should_be_reald()
    {
        ...
        {
            Parent = project, Project = project, Name = "Point 1", Start = DateTime.Now, End = DateTime.Now.AddDays(2)
        };
        var point2 = new Point
        {
            Parent = point1, Project = project, Name = "Point 2", Start = DateTime.Now, End = DateTime.Now.AddDays(2)
        };
