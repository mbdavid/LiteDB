...
public class FreePage_Tests
{
    ...
    public void FreeSlot_Insert()
    {
        using (var e = new LiteEngine())
        {
            ...
            colPage.FreeDataPageList.Should()
                .Equal(dataPage.PageID, uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue);
            ...
            colPage.FreeDataPageList.Should()
                .Equal(uint.MaxValue, dataPage.PageID, uint.MaxValue, uint.MaxValue, uint.MaxValue);
            ...
            colPage.FreeDataPageList.Should()
                .Equal(uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, dataPage.PageID);
            ...
            var dataPage2 =
                s.LocalPages.FirstOrDefault(x => x.PageType == PageType.Data && x.PageID != dataPage.PageID);

            dataPage2.FreeBytes.Should().Be(8118);

            // test slots (#0 for dataPage2 and #4 for dataPage1)
            colPage.FreeDataPageList.Should()
                .Equal(dataPage2.PageID, uint.MaxValue, uint.MaxValue, uint.MaxValue, dataPage.PageID);
            ...
            colPage.FreeDataPageList.Should()
                .Equal(uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue, dataPage2.PageID);
    ...
    public void FreeSlot_Delete()
    {
        using (var e = new LiteEngine())
        {
            ...
            var dataPage2 =
                s.LocalPages.FirstOrDefault(x => x.PageType == PageType.Data && x.PageID != dataPage1.PageID);
            ...
            colPage.FreeDataPageList.Should()
                .Equal(uint.MaxValue, uint.MaxValue, uint.MaxValue, dataPage1.PageID, dataPage2.PageID);
