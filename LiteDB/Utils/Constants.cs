...
internal class Constants
{
    ...
    /// <summary>
    ///     Define how many pages all transaction will consume, in memory, before persist in disk. This amount are shared
    ///     across all open transactions
    ///     100,000 ~= 1Gb memory
    /// </summary>
    ...
    /// </summary>
    public static int[] MEMORY_SEGMENT_SIZES = { 12, 50, 100, 500, 1000 }; // 8Mb per extend
