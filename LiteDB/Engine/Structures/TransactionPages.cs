...
{
    /// <summary>
    ///     Get how many pages are involved in this transaction across all snapshots - Will be clear when get
    ///     MAX_TRANSACTION_SIZE
    /// </summary>
    public int TransactionSize { get; set; } = 0;

    /// <summary>
    ///     Contains all dirty pages already persist in LOG file (used in all snapshots). Store in [uint, PagePosition] to
    ///     reuse same method in save pages into log and get saved page positions on log
    /// </summary>
