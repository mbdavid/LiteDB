...
public partial class LiteEngine
{
    ...
    private void TryUpgrade()
    {
            ...
            1024))
        {
            ...
            if (FileReaderV7.IsVersion(buffer) == false)
                return;
        }
    ...
    /// </summary>
    [Obsolete(
        "Upgrade your LiteDB v4 datafiles using Upgrade=true in EngineSettings. You can use upgrade=true in connection string.")]
