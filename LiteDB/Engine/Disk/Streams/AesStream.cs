...
public class AesStream : Stream
{
    ...
    public override int Read(byte[] array, int offset, int count)
    {
        ENSURE(
            ...
            "AesRead: position must be in PAGE_SIZE module. Position={0}, File={1}",
            Position,
            _name);
    ...
    public override void Write(byte[] array, int offset, int count)
    {
        ...
        ENSURE(
            Position == HeaderPage.P_INVALID_DATAFILE_STATE || Position % PAGE_SIZE == 0,
            "AesWrite: position must be in PAGE_SIZE module. Position={0}, File={1}",
            Position,
            _name);
