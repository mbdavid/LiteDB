...
namespace LiteDB.Engine
{
    ...
    {
        public GroupByPipe(LiteEngine engine, TransactionService transaction, bool disposeTransaction, IDocumentLoader loader)
            : base(engine, transaction, disposeTransaction, loader)
        {
        }
