...
/// <summary>
///     Class is a result from optimized QueryBuild. Indicate how engine must run query - there is no more decisions to
///     engine made, must only execute as query was defined
/// </summary>
