...
public partial class LiteCollection<T>
{
    ...
    public bool Update(T entity)
    {
        ...
        return _engine.Update(_collection, new[] { doc }) > 0;
    }
    ...
    /// <summary>
    ///     Update many documents based on transform expression. This expression must return a new document that will be
    ///     replaced over current document (according with predicate).
